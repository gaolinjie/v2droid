...
public class Style {
  ...
  static {
    ALERT = new Builder().setDuration(1000).setBackgroundColorValue(holoRedLight).setHeight(LayoutParams.WRAP_CONTENT).build();
    CONFIRM = new Builder().setDuration(1000).setBackgroundColorValue(holoGreenLight).setHeight(LayoutParams.WRAP_CONTENT).build();
    INFO = new Builder().setDuration(1000).setBackgroundColorValue(holoBlueLight).setHeight(LayoutParams.WRAP_CONTENT).build();
  }
